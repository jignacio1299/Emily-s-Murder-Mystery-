...
local function adjustCellSize()
    ...
    local newCellSizeY = cellSizeX * (686/494)
...
local function adjustCanvasPosition()
    ...
    scrollingFrame.CanvasSize = UDim2.new(scrollingFrame.CanvasSize.X.Scale, scrollingFrame.CanvasSize.X.Offset, 0, cellSizeY * 6)
