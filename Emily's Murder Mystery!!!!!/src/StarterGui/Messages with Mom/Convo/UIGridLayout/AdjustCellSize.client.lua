...
local function adjustCellSize()
    ...
    local newCellSizeY = cellSizeX * (1.538)
...
local function adjustCanvasPosition()
    ...
    scrollingFrame.CanvasSize = UDim2.new(scrollingFrame.CanvasSize.X.Scale, scrollingFrame.CanvasSize.X.Offset, 0, cellSizeY * 11)
