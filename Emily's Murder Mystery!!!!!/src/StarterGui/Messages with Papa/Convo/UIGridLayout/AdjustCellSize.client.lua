...
local function adjustCellSize()
    ...
    local newCellSizeY = cellSizeX * (846/498)
...
local function adjustCanvasPosition()
    ...
    scrollingFrame.CanvasSize = UDim2.new(scrollingFrame.CanvasSize.X.Scale, scrollingFrame.CanvasSize.X.Offset, 0, cellSizeY)
